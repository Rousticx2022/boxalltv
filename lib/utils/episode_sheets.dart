                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                    ...
                                    children: [
                                      ClipRRect(
                                        ...
                                        child: CachedNetworkImage(
                                          imageUrl:
                                              episodeList[index]['thumbnail'],
                                          placeholder: (c, s) => ColoredBox(
                                  ...
                                  if (episodeList[index]["episodeDescription"]
                                      .isNotEmpty)
                                    Padding(
                                      padding: const EdgeInsets.only(top: 10.0),
                                      child: ReadMoreText(
                                        episodeList[index]["episodeDescription"],
                                        trimLines: 2,
            ...
            Row(
              children: [
                ...
                TextButton(
                  ...
                  child: Text(
                    "Add Episode",
                    style: fontButton(fontSize: 14.5.sp),
                  ),
                ),
              ],
            ),
