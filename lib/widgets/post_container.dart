                          ...
                          menuChildren: [
                            ...
                            MenuItemButton(
                              ...
                              leadingIcon: Icon(Icons.delete,
                                  color: kSocialPrimaryColor, size: 16.sp),
                              child: Text('Delete',
                                  style: fontButton(
                                      fontSize: 15.sp,
                  ...
                  return ListTile(
                    ...
                    trailing: TextButton(
                      onPressed: () async {
                        ...
                        if (vdata["type"] == "RENT") {
                          DocumentSnapshot purchasedVideo =
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Expanded(
                    child: LikeButton(
                        uid: uid, postOwner: posts.uid, postID: posts.postID)),
                ...
                Expanded(
                  child: TextButton.icon(
                    ...
                    label: Text(Numeral(posts.shares).format(fractionDigits: 2),
                        style: customTextStyleBody(
                            fontSize: 14, fontWeight: FontWeight.w400)),
