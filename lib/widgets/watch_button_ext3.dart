  ...
  Widget buildMain(BuildContext context) {
    return widget.type == "FREE"
        ? TextButton(
            ...
            child: Text(
              widget.section == "series" ? "Episodes" : "Watch Now",
              style: widget.isSmall
                  ? customTextStyleBody(
                      fontSize: 14.sp,
        ...
        ? StreamBuilder<DocumentSnapshot>(
            ...
            builder: (context, psnapshot) {
              String btnText = "Rent for ${widget.pricing["validity"]} days";
        ...
        : StreamBuilder<DocumentSnapshot>(
            ...
            builder: (context, usnapshot) {
              ...
              if (usnapshot.hasData && usnapshot.data!.exists) {
                DateTime validity = DateTime.parse(
                  usnapshot.data!['subscriptionDuration'].toDate().toString(),
                );
                if (!validity.difference(DateTime.now()).isNegative) {
                  btnText = widget.section == "movies"
                      ? "Watch Now"
