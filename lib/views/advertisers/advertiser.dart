            ...
            : ListView(
                ...
                children: [
                  ListTile(
                    ...
                    title: Text(
                      "${controller.publishedAds.length}",
                  ...
                  ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      return ListTile(
                        ...
                        leading: Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: CachedNetworkImage(
                              imageUrl: controller.publishedAds[index]["logo"],
                        ...
                        title: Text(
                          controller.publishedAds[index]["title"],
                          maxLines: 1,
                          style: fontPoppins(fontSize: 17.sp),
                        ),
                        subtitle: Text(
                        ...
                        trailing: Chip(
                          label: Text(
                            ...
                            style: fontPoppins(
                              fontSize: 13.sp,
                              color: controller.publishedAds[index]["active"]
                                  ? Colors.green
                                  : Colors.red,
