  ...
  Widget buildMain(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          GetX<BottomTabController>(builder: (btController) {
            return ListTile(
              contentPadding: EdgeInsets.zero,
              title: RichText(
                text: TextSpan(
                  text: "${btController.userData["wallet"].toStringAsFixed(2)}",
                  style: fontBody(
                      fontSize: 24.sp,
                      color: kWhiteColor,
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text("Daily Check-in (Earn 1 coin)",
                    ...
                    return Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(getWeekdays(date.weekday).toUpperCase(),
                              style: fontBody(
                ...
                GestureDetector(
                  onTap: () async {
                    if (checkInDates
                        .contains(DateFormat("dd-MM-yyyy").format(today))) {
            ...
            trailing: Column(
              ...
              children: [
                Container(
                  ...
                  alignment: Alignment.center,
                  child: Text(rewardEarnedForSharing ? "Claimed" : "Earn",
                      style: fontBody(
                          fontSize: 15.sp,
                          fontWeight: FontWeight.w500,
                          color: kWhiteColor)),
            ...
            builder: (adsService) => ListTile(
              ...
              title: Text("Earn rewards",
                  style: fontBody(
                      ...
                      color: kWhiteColor,
                      fontWeight: FontWeight.w400)),
              subtitle: Text("Watch a video ad and earn 1 coin",
                  style: fontBody(
                      fontSize: 13.sp,
                      color: kWhiteColor.withValues(alpha: 0.7),
                      fontWeight: FontWeight.w400)),
